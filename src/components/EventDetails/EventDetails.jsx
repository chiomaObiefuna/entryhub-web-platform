...
export default function EventDetails() {
    ...
    const toggleSidebar = () => {
        console.log("Hamburger clicked! Current state is:", isSidebarOpen);
        ...
        <div className="event-details-layout">
            ...
            <aside className={`sidebar ${isSidebarOpen ? 'active' : ''}`}>
                ...
                <button 
                    ...
                    onClick={toggleSidebar} 
                    style={{ position: 'absolute', top: '20px', right: '20px', display: isSidebarOpen ? 'block' : 'none' }}
                >
                    <i className="ph ph-x"></i>
                </button>
                <div className="logo">entry<br/>hub</div>
                
                <div className="menu-heading">MAIN MENU</div>
                <nav className="sidebar-nav">
                    <a className="nav-item"><i className="ph ph-squares-four nav-icon"></i> Dashboard <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                    <a className="nav-item active"><i className="ph ph-house nav-icon"></i> Home <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                    <a className="nav-item"><i className="ph ph-calendar-blank nav-icon"></i> Events <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                    <a className="nav-item"><i className="ph ph-check-square-offset nav-icon"></i> In-Events <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                    <a className="nav-item"><i className="ph ph-ticket nav-icon"></i> My Tickets <div class="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                    <a className="nav-item"><i className="ph ph-hand-coins nav-icon"></i> Payment <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                    <a className="nav-item"><i className="ph ph-tote nav-icon"></i> Merchandise <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                </nav>
                
                <div className="menu-heading spacing-top">OTHER</div>
                <nav className="sidebar-nav">
                    <a className="nav-item"><i className="ph ph-gear nav-icon"></i> Settings <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                    <a className="nav-item"><i className="ph ph-question nav-icon"></i> Help & Support <div className="nav-arrow"><i className="ph ph-caret-right"></i></div></a>
                </nav>
            </aside>
            ...
            <main className="main-content">
                ...
                <section className="personal-info">
                    ...
                    <div className="input-group">
                        ...
                        <input type="text" id="fullName" defaultValue="Korede Bello" />
                    </div>
                    <div className="input-group">
                        <label htmlFor="email">Email</label>
                        <input type="email" id="email" defaultValue="koredebello4life@gmail.com" />
                    </div>
                </section>
