...
// ✅ Import only if you need it for logic, but we won't wrap with it here
...
const EventPage = () => {
  ...
  // ✅ REMOVED <DashboardLayout> wrap from here
  return (
      ...
      {loading ? (
        ...
        events.map((event) => (
          ...
          style={{ cursor: 'pointer' }}>
            ...
            <img 
              src={event.image || CINEMA_PLACEHOLDER} 
              alt={event.title} 
              ...
              <p className="card-meta">
                {event.date ? (
                  <>
                    ...
                    } {new Date(event.date).toLocaleString('en-GB', { month: 'long', year: 'numeric' })}
                  </>
            ...
            <div className="event-card-actions">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#667D78" strokeWidth="1.5">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
              </svg>
              <div className="bottom-actions-row">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#667D78" strokeWidth="1.5">
