...
<p className='icon-text'><span className='icon-wrapper-loa'><img src={LocationIcon} alt="Location" /></span>{event.Location}</p><p className='card-price'>From: NGN{event.price}</p>
</div>
